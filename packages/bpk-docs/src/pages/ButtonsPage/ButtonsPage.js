...
const components = [
  {
    ...
    examples: [
      <div className={buttonContainerClassName}>
        <BpkButton className={buttonClassName} primary>
          Primary
        </BpkButton>
        <BpkButton className={buttonClassName} primary disabled>
          Disabled
        </BpkButton>
      </div>,
      <div className={buttonContainerClassName}>
        <BpkButton className={buttonClassName} large primary>
          Primary
        </BpkButton>
        <BpkButton className={buttonClassName} large primary disabled>
          Disabled
        </BpkButton>
      </div>,
    ],
